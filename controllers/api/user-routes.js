...
// whereas a POST method carries the request parameter in req.body, which 
...
// in the update and req.params.id to indicate where exactly we want that new data to be used.
